...
export default function ManagerTenantManagement() {
  ...
  // 1. Tải danh sách Dãy trọ (API Admin/Manager lấy toàn bộ hệ thống)
  const fetchMotels = async () => {
    ...
    try {
      ...
      console.error('Lỗi khi tải danh sách dãy trọ hệ thống:', err);
      setIsFetching(false);
    }
  };
  ...
  return (
    <div className="d-flex">
      ...
      <div className="flex-grow-1 p-4 bg-light min-vh-100" style={{ marginLeft: '260px' }}>
        <h3 className="fw-bold mb-4">👥 Quản Lý Khách Thuê (Manager)</h3>
