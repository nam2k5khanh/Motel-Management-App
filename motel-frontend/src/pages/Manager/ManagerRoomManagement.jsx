...
export default function ManagerRoomManagement() {
  ...
  // Lấy tất cả dãy trọ trong hệ thống dành cho Người quản lý
  const fetchMotels = async () => {
    try {
      const res = await axiosClient.get('/admin/motels');
      ...
      console.error('Lỗi tải danh sách dãy trọ hệ thống:', err);
    }
  };
  ...
  return (
    <div className="d-flex">
      ...
      <div className="flex-grow-1 p-4 bg-light min-vh-100" style={{ marginLeft: '260px' }}>
        <h3 className="fw-bold mb-4">🚪 Quản Lý Phòng Trọ (Manager)</h3>
        ...
        <div className="card border-0 shadow-sm mb-4">
          <div className="card-body d-flex align-items-center">
            ...
            >
              {motels.length === 0 ? (
                <option value="">Chưa có dãy trọ nào trên hệ thống</option>
              ) : (
                motels.map(m => (
