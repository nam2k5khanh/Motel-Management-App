      ...
      <header className="navbar navbar-dark bg-primary sticky-top px-3 shadow-sm d-lg-none d-print-none" style={{ zIndex: 1030, height: '56px' }}>
        <div className="d-flex align-items-center w-100 justify-content-between">
          <div className="d-flex align-items-center gap-2">
            ...
            <span className="navbar-brand fw-bold mb-0 me-0 fs-6">SỰ CỐ & SỬA CHỮA</span>
          </div>
          <button 
        ...
        <div className="main-content-area flex-grow-1 p-3 p-md-4 overflow-hidden">
          ...
          <div className="d-flex justify-content-between align-items-center mb-4">
            <button 
              ...
              disabled={isLoading}
            >
              <i className={`bi bi-arrow-clockwise me-1 ${isLoading ? 'spin' : ''}`}></i> Làm mới
            </button>
          </div>
          ...
          <div className="row g-3 g-md-4">
            ...
            <div className="col-12 col-lg-5">
              <div className="card border-0 shadow-sm rounded-4 p-3 p-md-4 bg-white">
                <h5 className="fw-bold text-primary mb-3 fs-5">Tạo yêu cầu mới</h5>
            ...
            <div className="col-12 col-lg-7">
              <div className="card border-0 shadow-sm rounded-4 p-3 p-md-4 bg-white">
                <h5 className="fw-bold text-secondary mb-3 fs-5">Lịch sử báo cáo & Tiến độ</h5>
                ...
                {isLoading ? (
                  ...
                  <div className="text-center py-5">
                    ...
                    <p className="text-muted small mb-0">Chưa có lịch sử báo cáo sự cố nào.</p>
                  </div>
                ) : (
