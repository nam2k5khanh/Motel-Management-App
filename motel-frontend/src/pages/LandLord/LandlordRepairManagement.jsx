        ...
        <div className="main-content-area flex-grow-1 p-3 p-md-4">
          ...
          <div className="row g-2 g-md-3 mb-4">
            <div className="col-6 col-md-3">
              <div className="card border-0 shadow-sm p-2 p-md-3 bg-white h-100">
                <small className="text-muted fw-semibold d-block text-truncate" style={{ fontSize: '0.75rem' }}>Tổng Số Sự Cố</small>
                <h4 className="fw-bold text-dark m-0 mt-1 fs-5 fs-md-4">{totalRequests}</h4>
              </div>
            </div>
            <div className="col-6 col-md-3">
              <div className="card border-0 shadow-sm p-2 p-md-3 bg-white border-start border-warning border-4 h-100">
                <small className="text-warning fw-bold d-block text-truncate" style={{ fontSize: '0.75rem' }}>Chờ Xử Lý</small>
                <h4 className="fw-bold text-warning m-0 mt-1 fs-5 fs-md-4">{pendingCount}</h4>
              </div>
            </div>
            <div className="col-6 col-md-3">
              <div className="card border-0 shadow-sm p-2 p-md-3 bg-white border-start border-primary border-4 h-100">
                <small className="text-primary fw-bold d-block text-truncate" style={{ fontSize: '0.75rem' }}>Đang Sửa Chữa</small>
                <h4 className="fw-bold text-primary m-0 mt-1 fs-5 fs-md-4">{inProgressCount}</h4>
              </div>
            </div>
            <div className="col-6 col-md-3">
              <div className="card border-0 shadow-sm p-2 p-md-3 bg-white border-start border-success border-4 h-100">
                <small className="text-success fw-bold d-block text-truncate" style={{ fontSize: '0.75rem' }}>Đã Hoàn Thành</small>
                <h4 className="fw-bold text-success m-0 mt-1 fs-5 fs-md-4">{completedCount}</h4>
              </div>
            </div>
          </div>
            ...
            <div className="card-header bg-white py-3">
              <div className="row align-items-center g-2">
                <div className="col-12 col-xl-3">
                  <h6 className="fw-bold m-0 text-dark">Danh Sách Báo Cáo ({filteredRequests.length})</h6>
                </div>
                ...
                <div className="col-12 col-xl-3">
                  <input
                    ...
                    placeholder="🔍 Tìm tiêu đề, phòng, tên, SĐT..."
                    value={searchTerm}
                      ...
                      filteredRequests.map(item => {
                        ...
                        return (
                          <tr key={item.id}>
                            ...
                            <td>
                              <div className="fw-bold text-primary mb-1 small">
                            ...
                            <td style={{ maxWidth: '240px', whiteSpace: 'normal' }}>
                              ...
                              <div className="text-secondary small text-truncate" style={{ maxWidth: '220px' }}>{item.description}</div>
                            ...
                            <td>
                              {fullImageUrl ? (
                                ...
                                <span className="text-muted small" style={{ fontSize: '0.75rem' }}>Không có</span>
                              )}
                            </td>
              ...
              <div className="modal-dialog modal-dialog-centered modal-lg" onClick={e => e.stopPropagation()}>
                <div className="modal-content border-0 shadow-lg">
                  <div className="modal-header py-2">
                    <h6 className="modal-title fw-bold">📷 Ảnh Chi Tiết Sự Cố</h6>
                    <button
                      type="button"
                      className="btn-close"
                      onClick={() => setPreviewImage(null)}
